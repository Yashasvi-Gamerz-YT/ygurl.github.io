...
<?php
if ($check) {
	echo '<div class="alert alert-success" role="alert"><b>' . __('Nulled by: xc0ver | w3bN1nJa') . '</b></div>';
	echo '<div class="alert alert-danger" role="alert"><b>' . __('WWW.CUTFLYURL.XYZ') . '</b></div>';
